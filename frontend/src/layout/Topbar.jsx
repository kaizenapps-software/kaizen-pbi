...
export default function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-transparent">
      <div className="flex items-center justify-between gap-3 px-3 md:px-4 py-3" style={{height:'var(--topbar-h)'}}>
            ...
            {menuOpen && (
              <nav className="user-menu absolute right-0 top-full mt-2 z-[100]" role="menu">
                <a onClick={goProfile} role="menuitem">
                  <span className="ico">
                    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M12 12a5 5 0 1 0-5-5 5 5 0 0 0 5 5Zm7 9a7 7 0 0 0-14 0"/></svg>
                  </span>
                  <span>Mi perfil</span>
                </a>
                <a onClick={logout} role="menuitem">
                  <span className="ico">
                    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="M16 17l5-5-5-5"/><path d="M21 12H9"/></svg>
                  </span>
